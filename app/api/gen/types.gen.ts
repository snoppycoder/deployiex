...
export type CategoryControllerFindAllByOrganizationData = {
    body?: never;
    path: {
        id: string;
    };
...
export type CategoryControllerFindAllByOrganizationErrors = {
    /**
     * Bad Request
     */
    400: ErrorDto;
...
export type CategoryControllerFindAllByOrganizationError = CategoryControllerFindAllByOrganizationErrors[keyof CategoryControllerFindAllByOrganizationErrors];

export type CategoryControllerFindAllByOrganizationResponses = {
    /**
     * OK
     */
    200: CategoryDto;
...
export type CategoryControllerFindAllByOrganizationResponse = CategoryControllerFindAllByOrganizationResponses[keyof CategoryControllerFindAllByOrganizationResponses];
...
export type ExpenseControllerGetExpenseInfoData = {
    body?: never;
    path: {
        userId: string;
    };
...
export type ExpenseControllerGetExpenseInfoResponses = {
    200: unknown;
};

export type ExpenseControllerFindByUserData = {
    body?: never;
    path: {
        userId: string;
    };
...
export type ExpenseControllerFindByUserResponses = {
    200: unknown;
};
