...
export default function Navbar() {
  ...
  return (
    <div className="relative w-full md:min-h-screen ">
      ...
      <nav
        className={`fixed top-0 left-0 md:static justify-between z-20 w-64 h-screen flex flex-col gap-y-3 p-2 border-r border-gray-300 bg-white transform transition-transform duration-300
  ${isOpen ? "translate-x-0" : "-translate-x-full"} 
  md:static md:translate-x-0`}
      >
        <div className="flex flex-1 flex-col gap-y-3 p-2 overflow-y-auto">
